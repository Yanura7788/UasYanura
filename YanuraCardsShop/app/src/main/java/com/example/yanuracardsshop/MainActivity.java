...
public class MainActivity extends AppCompatActivity {
    ...
    private void perseJSON() {
        String url="https://xaviernoalexander.000webhostapp.com/koneksi.php";
                    ...
                    public void onResponse(JSONArray response) {
                        ...
                        try {
                            for (int i = 0; i < jumdata; i++) {
                                ...
                                String itemmenu = data.getString("itemdetail");
                                menus.add(new Menu(namamenu, hargamenu, gambarmenu, itemmenu));
                            }
